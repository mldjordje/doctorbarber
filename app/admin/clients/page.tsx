...
export default function AdminClientsPage() {
  ...
  > = {
    ...
    de: {
      ...
      cannotLoad: "Kunden konnten nicht geladen werden.",
      listRefreshed: "Kundenliste aktualisiert.",
      genericError: "Etwas ist schiefgelaufen.",
      fillClient: "Name und Telefonnummer des Kunden eingeben.",
      cannotSave: "Kunde konnte nicht gespeichert werden.",
      saved: "Kunde gespeichert.",
      title: "Kunden",
      subtitlePrefix: "Gesamtzahl Kunden:",
      refreshList: "Liste aktualisieren",
      noClients: "Keine registrierten Kunden.",
      editClient: "Kunde bearbeiten",
      selectClient: "Kunden zum Bearbeiten auswählen",
      fullName: "Vollständiger Name",
      phone: "Telefon",
      emailOptional: "E-Mail (optional)",
      address: "Adresse",
      clientDesc: "Kundennotizen",
      cancel: "Abbrechen",
