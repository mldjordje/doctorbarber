...
export default function AdminSettingsPage() {
  ...
  const text: Record<Language, Record<string, string>> = {
    ...
    de: {
      ...
      bookingMinutesInvalid: "Gib eine gültige Vorlaufzeit für Buchungen in Minuten ein.",
      cancelMinutesInvalid: "Gib eine gültige Vorlaufzeit für Stornierungen in Minuten ein.",
      cannotSave: "Einstellungen konnten nicht gespeichert werden.",
      saved: "Einstellungen gespeichert.",
      genericError: "Etwas ist schiefgelaufen.",
      title: "Einstellungen",
      subtitle: "Buchungs- und Stornierungsregeln verwalten",
      rulesTitle: "Terminregeln",
      minBooking: "Mindestminuten vor Buchung",
      minCancel: "Mindestminuten vor Stornierung",
      homepageNotice: "Hinweis auf der Startseite",
      homepageNoticeHint: "Kurzer Hinweis, der Besuchern sofort beim Öffnen der Website angezeigt wird.",
